...
class RedistStateBuilder[K, V](val numOfSubtasks: Int,
...
class NettyRedistConnection[K, V](val addr: RedistributorAddress,
                                  val netEnv: RedistributionNetworkEnvironment)
