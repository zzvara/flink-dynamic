...
class RedistributeStateHandler(val masterRef: ActorRef,
  ...
  private var localState: Option[scala.collection.mutable.HashMap[Any, Any]] = None
  private var allNewState: Option[scala.collection.mutable.HashMap[Any, Any]] = None
  ...
  if (hasKeyedState) {
    redistServer = Some(new RedistributeServer(new NettyServerHandler[Any, Any](4,
      new AllNewStateArrivedListener[Any, Any] {
        override def onAllNewStateArrived(statesByKey: scala.collection.mutable.HashMap[Any, Any]): Unit = {
